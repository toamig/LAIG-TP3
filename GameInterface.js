...
class GameInterface {
    ...
    init() {
        ...
        let player_coords = [0.1, 0.95];
        let player_width = 0.20;
        let player_height = 0.20;
        let icePlayer = new InterfaceComponent(this.scene, player_coords, player_width, player_height, "ice.png");
        let blackPlayer = new InterfaceComponent(this.scene, player_coords, player_width, player_height, "black.png");
        this.ui_elements["icePlayer"] = icePlayer;
        this.ui_elements["blackPlayer"] = blackPlayer;
        ...
        let icePlayerwinner = new InterfaceComponent(this.scene, winner_coords, player_width, player_height, "ice.png");
        let blackPlayerwinner = new InterfaceComponent(this.scene, winner_coords, player_width, player_height, "black.png");
        this.ui_elements["iPlayerwinner"] = icePlayerwinner;
        this.ui_elements["bPlayerwinner"] = blackPlayerwinner;
    ...
    display() {
        ...
        // BIG TODO: Lot's of mess in names
        if (this.game.inited) {
            ...
            if (!this.game.terminated) {
                ...
                this.ui_elements[this.game.winner + "Playerwinner"].display();
            }
        }
        else{
    ...
    updateScore() {
        ...
        if (this.scene.graph) {
            this.ui_elements["white_score"].texture = this.timer_textures[this.game.points[0]];
            this.ui_elements["black_score"].texture = this.timer_textures[this.game.points[1]];
        }
    }
    ...
    initTimer() {
        ...
        this.timer_textures[10] = new CGFtexture(this.scene, "scenes/images/colon.png");
    ...
    initCounter() {
        ...
        this.timer_textures[11] = new CGFtexture(this.scene, "./scenes/" + "images/minus.png");
