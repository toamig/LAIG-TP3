        ...
        for (var i = 0; i < children.length; i++) {
            ...
            if (grandChildren.length != 1 ||
                (grandChildren[0].nodeName != 'rectangle' && grandChildren[0].nodeName != 'triangle' &&
                    ...
                    grandChildren[0].nodeName != 'board' && grandChildren[0].nodeName != 'pieces')) {
            ...
            {     
                ...
                var board = new MyBoard(this.scene, primitiveId);
                
                this.primitives[primitiveId] = board;
            }
            else if(primitiveType == 'pieces'){

                var pieces = new MyPieces(this.scene, primitiveId);
                
                this.primitives[primitiveId] = pieces;
            }
        }
